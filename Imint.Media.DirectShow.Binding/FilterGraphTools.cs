...
namespace DirectShowLib.Utils
{
	...
	public sealed class FilterGraphTools
	{
		...
		/// <summary>
		/// Display Bits Pages of a given DirectShow filter
		/// </summary>
		/// <param name="filter">A DirectShow Filter</param>
		...
		/// <remarks>
		/// You can check if a filter supports Bits Pages with the <see cref="HasPropertyPages">HasPropertyPages</see> method.<br/>
		/// <strong>Warning</strong> : This method is blocking. It only returns when the Bits Pages are closed.
		/// </remarks>
		/// <example>This sample shows how to check if a filter supports Bits Pages and displays them
		/// <code>
